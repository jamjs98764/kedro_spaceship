...
# spaceship_kedro_package documentation build
...
from spaceship_kedro_package import __version__ as release

# -- Project information -----------------------------------------------------

project = "spaceship_kedro_package"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "spaceship_kedro_packagedoc"
...
latex_documents = [
    (
        master_doc,
        "spaceship_kedro_package.tex",
        "spaceship_kedro_package Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spaceship_kedro_package",
        "Project spaceship_kedro_package codebase.",
        "Data-Science",
    )
]
